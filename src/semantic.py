...
from .inference import MultiProviderClient
...
class SemanticJudge:
    ...
    def __init__(
        ...
        Args:
            ...
            judge_model: Model identifier for judging equivalence.
...
if __name__ == "__main__":
    ...
    judge = SemanticJudge(MockClient(), "test-model", "openai")  # type: ignore
